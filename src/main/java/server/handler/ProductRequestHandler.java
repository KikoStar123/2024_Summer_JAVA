    ...
    public String handle(JSONObject parameters) {
        ...
        switch (action) {
            ...
            case "search": // 支持带排序的搜索，已实现
                ...
                sortBy = parameters.optString("sortBy", "price");  // 默认按价格排序
                sortOrder = parameters.optString("sortOrder", "ASC");  // 默认升序排序
            ...
            case "getProductComments": // 查询商品的评论（商品详情页），已实现
                productID = parameters.getString("productID");
            ...
            case "addComment": // 添加评论，需添加 storeID
