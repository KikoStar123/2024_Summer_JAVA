...
//        courseListView.getStyleClass().add("gray-border");
    ...
    private GridPane createScheduleView() {
        ...
        for (int i = 0; i < periods.length; i++) {
            ...
            Platform.runLater(() -> {
                double width = periodLabel.getBoundsInParent().getWidth();
                double height = periodLabel.getBoundsInParent().getHeight();
                System.out.println("period Label Width: " + width + ", Height: " + height);
            });
        }
        ...
        for (int i = 0; i < days.length; i++) {
            ...
            Platform.runLater(() -> {
                double width = dayLabel.getBoundsInParent().getWidth();
                double height = dayLabel.getBoundsInParent().getHeight();
                System.out.println("Day Label Width: " + width + ", Height: " + height);
            });
